...
class MyGrid(GridLayout):
	...
	def __init__(self, **kwargs):
	    ...
	    self.label_info = Label(text="Minimum time interval is 5 min!", font_size=50)
	...
	def start_notifications(self, obj):
		...
		event = Clock.schedule_interval(self.send_notificatons, notify_secs / 1.)
